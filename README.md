...
6. When the setup ends, open skills from your Start menu or desktop
...
3. If the app asks for a folder, choose a place you can find again
4. If the app asks for access to files, allow it so it can save your work
5. Start with one simple item so you can learn the layout fast
...
4. Add notes or steps
5. Save it
6. Open it later to keep working
...
4. Open the new file
5. Keep your existing work folder if the app uses one

Using the latest release helps keep the app smooth and current.

## 📖 Best way to use skills
...
## 🧠 Based on The Minimalist Entrepreneur
...
## 🖱️ Need help finding the download
...
- .zip — a folder that needs to be unpacked first
- Source code files — not needed for normal use
